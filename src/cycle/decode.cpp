...
class DECODE {
    private:
        #define div 0x55  // divisions
        #define sub 0x11  // subelements

    public:
        // Hybrid binary search: Splits first into 3 elements then 5 sub for each
        void Decode(
            const u_char &opcode, 
            ...
            if (opcode <= div) {
                ...
                if (opcode <= sub * 11) {
                    ...
                    switch (opcode) {
                        ...
                        case 0xF6:
                        case 0xF7:
                        case 0xF8: ORIGINAL::CLC(); break;
                        case 0xF9:
                        case 0xFA: ORIGINAL::CLI(); break;
                        case 0xFB:
                        case 0xFC: ORIGINAL::CLD(); break;
                        case 0xFD:
                        case 0xFE:
                        case 0xFF:
                    }
