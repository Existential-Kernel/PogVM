...
std::string ASSEMBLY::Filter(const std::string &string) {
...
std::string ASSEMBLY::Trim(const std::string &string) {
...
std::vector<std::string> ASSEMBLY::Split(const std::string &string) {
    svec vector;
...
std::vector<std::string> ASSEMBLY::Preprocess(std::string &line) {
...
bool ASSEMBLY::CheckASM(const std::string &file) {
...
void ELFHEADER::OutputELFHeader(void) {
...
void ELFHEADER::OutputELFProgram(const std::vector<unsigned char> &header) {
...
void ELFHEADER::GetELFHeader(const std::vector<unsigned char> &hex) {
...
[[noreturn]] void ELFHEADER::OutputELF(const uint8_t &option, const std::vector<unsigned char> &header) {
    GetELFHeader(header);
...
std::vector<uint8_t> ELFHEADER::GetCode(void) {
...
inline bool ELF::CheckELF(const std::string &filename) {
...
std::vector<uint8_t> ELF::FetchHex(const std::string &filename) {
    std::ifstream file(filename, std::ios::binary);
